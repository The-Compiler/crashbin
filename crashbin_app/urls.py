...
from crashbin_app.views import misc_views, report_views, setting_views, bin_views, label_views
...
urlpatterns = [
    ...
    path('report/<int:pk>/settings/<str:setting>', setting_views.settings, name='report_settings'),
    ...
    path('bin/<int:pk>/settings/<str:setting>', setting_views.settings, name='bin_settings'),
